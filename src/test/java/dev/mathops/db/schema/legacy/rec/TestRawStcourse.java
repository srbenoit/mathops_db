...
/**
 * Tests for the {@code RawStcourse} class.
 */
final class TestRawStcourse {
    ...
    /**
     * Constructs a new {@code IvtRawStcourse}.
     */
    TestRawStcourse() {
    ...
    void test0001() {
        ...
        final RawStcourse obj = new RawStcourse(TEST_TERM, RawStudent.TEST_STUDENT_ID, TEST_COURSE, TEST_SECT,
