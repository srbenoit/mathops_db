...
final class TestRes extends ResBundle {
    ...
    /** A resource key. */
    static final String ERR_NO_IFXTEST_PROFILE = key(2);

    /** A resource key. */
    static final String ERR_NO_PGPRIMARY_CONTEXT = key(3);
    ...
    /** A resource key. */
    static final String ERR_NO_TERM_PREFIX = key(6);
    ...
    private static final String[][] EN_US = {
            ...
            {ERR_NO_IFXTEST_PROFILE, "No primary context in the 'ifxtest' code profile."},
