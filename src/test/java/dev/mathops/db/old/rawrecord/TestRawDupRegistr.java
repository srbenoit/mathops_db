...
/**
 * Tests for the {@code RawDupRegistr} class.
 */
final class TestRawDupRegistr {
    ...
    /** A field name. */
    private static final TermKey TEST_I_TERM = new TermKey(ETermName.SPRING, 2023);
    ...
    /**
     * Constructs a new {@code IvtRawDupRegistr}.
     */
    TestRawDupRegistr() {
