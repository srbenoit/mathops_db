 ...
 */
public final class StandardMilestoneLogic implements ILegacyRecLogic<StandardMilestoneRec> {

    /** A single instance. */
    public static final StandardMilestoneLogic INSTANCE = new StandardMilestoneLogic();
    ...
    public static String getTableName(final Cache cache) {
        ...
        return schemaPrefix == null ? "std_milestone" : (schemaPrefix + ".std_milestone");
    }
     ...
     */
    @Override
    public boolean insert(final Cache cache, final StandardMilestoneRec record) throws SQLException {
        ...
        final String sql = SimpleBuilder.concat("INSERT INTO ", tableName,
                " (pace_track,pace,pace_index,unit,objective,ms_type,ms_date) VALUES (",
     ...
     */
    @Override
    public boolean delete(final Cache cache, final StandardMilestoneRec record) throws SQLException {
    ...
    public boolean updateDate(final Cache cache, final StandardMilestoneRec record,
        ...
        final String sql = SimpleBuilder.concat(
                "UPDATE ", tableName, " SET ms_date=", sqlDateValue(newDate),
                " WHERE pace_track=", sqlStringValue(record.paceTrack),
                " AND pace=", sqlIntegerValue(record.pace),
                " AND pace_index=", sqlIntegerValue(record.paceIndex),
                " AND unit=", sqlIntegerValue(record.unit),
