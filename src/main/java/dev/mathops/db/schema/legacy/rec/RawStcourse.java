...
/**
 * A raw "stcourse" record.
 */
public final class RawStcourse extends RawTermRecordBase implements Comparable<RawStcourse> {

    /** The table name. */
    public static final String TABLE_NAME = "stcourse";
    ...
    /** Grade strings that map to a GPA value of 4.00. */
    public static final List<String> COURSE_GRADES_400 =
            List.of("A+", "TA+", "RA+", "XA+", "AMA+", "A", "TA", "RA", "XA", "AMA");

    /** Grade strings that map to a GPA value of 3.67. */
    public static final List<String> COURSE_GRADES_367 = List.of("A-", "TA-", "RA-", "XA-", "AMA-");

    /** Grade strings that map to a GPA value of 3.33. */
    public static final List<String> COURSE_GRADES_333 = List.of("B+", "TB+", "RB+", "XB+", "AMB+");

    /** Grade strings that map to a GPA value of 3.00. */
    public static final List<String> COURSE_GRADES_300 = List.of("B", "TB", "RB", "XB", "AMB");

    /** Grade strings that map to a GPA value of 2.67. */
    public static final List<String> COURSE_GRADES_267 = List.of("B-", "TB-", "RB-", "XB-", "AMB-");

    /** Grade strings that map to a GPA value of 2.33. */
    public static final List<String> COURSE_GRADES_233 = List.of("C+", "TC+", "RC+", "XC+", "AMC+");

    /** Grade strings that map to a GPA value of 2.00. */
    public static final List<String> COURSE_GRADES_200 = List.of("C", "TC", "RC", "XC", "AMC", "S");

    /** Grade strings that map to a GPA value of 1.67. */
    public static final List<String> COURSE_GRADES_167 = List.of("C-", "TC-", "RC-", "XC-", "AMC-");
    ...
    /**
     * Constructs a new {@code RawStcourse}.
     */
    public RawStcourse() {
     ...
     */
    public RawStcourse(final TermKey theTermKey, final String theStuId, final String theCourse,
     ...
     */
    public static RawStcourse fromResultSet(final ResultSet rs) throws SQLException {

        final RawStcourse result = new RawStcourse();
     ...
     */
    @Override
    public int compareTo(final RawStcourse o) {
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj == this) {
            equal = true;
        } else if (obj instanceof final RawStcourse rec) {
