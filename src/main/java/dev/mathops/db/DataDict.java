...
public enum DataDict {
    ...
    /** A field name for serialization of records. */
    public static final String FLD_PREF_VALUE = "pref_value";
    ...
    /** A field name for serialization of records. */
    public static final String FLD_RESPONSE_DATE = "response_date";

    /** A field name for serialization of records. */
    public static final String FLD_RESPONSE_TEXT = "response_text";

    /** A field name for serialization of records. */
    public static final String FLD_RESPONSE_TIME = "response_time";
