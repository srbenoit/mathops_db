...
final class Res extends ResBundle {
    ...
    /** A resource key. */
    static final String BAD_SHORT_TERM = key(1);

    /** A resource key. */
    static final String NULL_SHORT_TERM = key(2);

    /** A resource key. */
    static final String BAD_LONG_TERM = key(3);

    /** A resource key. */
    static final String NULL_LONG_TERM = key(4);
