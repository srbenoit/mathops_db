package dev.mathops.db.table.constraint;
...
public final class ByteRangeConstraint extends AbstractFieldConstraint<Byte> {
    ...
    public ByteRangeConstraint(final String theName, final byte theMinValue, final byte theMaxValue) {
        ...
        if ((int) theMaxValue < (int) theMinValue) {
    ...
    public boolean isValid(final Byte value) {
        ...
        final int byteValue = (int)value.byteValue();

        return byteValue >= (int) this.minValue && byteValue <= (int) this.maxValue;
    }
    ...
    public String toString() {
        ...
        return CharSimpleBuilder.concat("ByteRangeConstraint{minValue=", minValueStr, ",maxValue=", maxValueStr, "}");
    }
}
