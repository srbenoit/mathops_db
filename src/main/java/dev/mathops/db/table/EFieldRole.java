...
public enum EFieldRole {
    ...
    /**
     * The field participates in the primary key, and can be used to partition data between nodes.  Such a field may not
     * contain a null value.
     */
    PARTITION_KEY(false),

    /**
     * The field participates in the primary key, and can be used to cluster data within a node.  Such a field may not
     * contain a null value.
     */
    ...
    /**
     * Tests whether the field is nullable.
     *
